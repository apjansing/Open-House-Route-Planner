...
\begin{figure}[!htb]
 ...
 {'_id': ObjectId('5cac003a671c85002d41afb9'), 'url': REDACTED, 'dtstart': '20190413T150000Z', 'dtend': '20190413T170000Z', 'summary': REDACTED 'description': 'REDACTED, 'location': {'geometry': {'x': x_2, 'y': y_2, 'spatialReference': {'wkid': 4326, 'latestWkid': 4326}}, 'attributes': {'Loc_name': 'World', 'Status': 'M', 'Score': 100, ... 'X': x_2, 'Y': y_2, 'DisplayX': x_{d2}, 'DisplayY': y_{d2}, 'Xmin': x_{min2}, 'Xmax': x_{max2}, 'Ymin': y_{min2}, 'Ymax': y_{max2}, 'ExInfo': '', 'OBJECTID': 1}, 'address': REDACTED},, 'address_hash': sha1(location2), 'durations': [[0, 14.15]]}]
  \end{lstlisting}
  \caption{Simplified Directions Array (Matrix).}\label{simplified directions array}
\end{figure}

With the directions matrix, all the information has been gathered to creating a graph and working through the problem of finding routes that direct users to a maximum number of houses.
